...
public static class Util
{
    ...
    public static void Log(string msg, LogColor color = LogColor.None)
    {
        if (AppConst.LogMode)
        {
            ...
            else
            {
                ...
                Debug.Log($"Framework <color={msgColor}> XY ---> {msg}</color>");
            }
        }
    }
    #endregion
    ...
    {
        return Resources.Load<GameSettings>(AppConst.FrameworkName);
    }
    /// <summary>
    /// 应用程序内容路径
    /// </summary>
    public static string AppContentPath()
    {
        ...
        switch (Application.platform)
        {
            case RuntimePlatform.Android:
                path = Application.streamingAssetsPath + "/xiyu/";
                break;
    ...
    {
        string url = Application.persistentDataPath + "/Resources/";
